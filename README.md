# [Ansible role postgres](#ansible-role-postgres)
...
postgres_listen_addresses: "127.0.0.1, ::1"

postgres_max_wal_size: 1GB
postgres_min_wal_size: 80MB
postgres_log_timezone: Etc/UTC
postgres_datestyle: iso, ymd
postgres_timezone: Etc/UTC
...
If you find issues, please register them on [GitHub](https://github.com/robertdebock/ansible-role-postgres/issues).
